...
import MySQLdb
import random
con = MySQLdb.connect('http', 'user', 'passwd', 'db')
cur = con.cursor()
file = open("url", 'wr')
...
for j in range(10):
	for i in range(5):
		...
		file.write("Payments: ")
		file.write(json.dumps(cur.fetchall(), sort_keys=True))
		file.write("\n")
